...
return array(
    ...
    'RP4WP_Cli_Command' => $baseDir . '/classes/cli/class-cli-command.php',
    'RP4WP_Cli_Command_Dev' => $baseDir . '/classes/cli/class-cli-command-dev.php',
    'RP4WP_Cli_Command_Provider' => $baseDir . '/classes/cli/class-cli-command-provider.php',
    'RP4WP_Component_Wrapper' => $baseDir . '/classes/class-component-wrapper.php',
    ...
    'RP4WP_Hook_Ajax_Install_Reinstall' => $baseDir . '/classes/hooks/class-hook-ajax-install-reinstall.php',
    'RP4WP_Hook_Ajax_Install_Relink' => $baseDir . '/classes/hooks/class-hook-ajax-install-relink.php',
    'RP4WP_Hook_Ajax_Install_Save_Options' => $baseDir . '/classes/hooks/class-hook-ajax-install-save-options.php',
    'RP4WP_Hook_Ajax_Install_Save_Words' => $baseDir . '/classes/hooks/class-hook-ajax-install-save-words.php',
    'RP4WP_Hook_Ajax_Install_Set_Post_Types' => $baseDir . '/classes/hooks/class-hook-ajax-install-set-post-types.php',
    ...
    'RP4WP_Hook_Meta_Box_Options' => $baseDir . '/classes/hooks/class-hook-meta-box-options.php',
    ...
    'RP4WP_Hook_Save_Meta_Box_Options' => $baseDir . '/classes/hooks/class-hook-save-meta-box-options.php',
    ...
    'RP4WP_Hook_Thumbnail' => $baseDir . '/classes/hooks/class-hook-thumbnail.php',
    ...
    'RP4WP_Manager_Component' => $baseDir . '/classes/class-manager-component.php',
    'RP4WP_Manager_Filter' => $baseDir . '/classes/class-manager-filter.php',
    'RP4WP_Manager_Frontend' => $baseDir . '/classes/class-manager-frontend.php',
    'RP4WP_Manager_Hook' => $baseDir . '/classes/class-manager-hook.php',
    'RP4WP_Manager_Settings_Messages' => $baseDir . '/classes/class-manager-settings-messages.php',
    'RP4WP_Manager_Template' => $baseDir . '/classes/class-manager-template.php',
    'RP4WP_Manager_Weights' => $baseDir . '/classes/class-manager-weights.php',
    'RP4WP_Meta_Box_Manage' => $baseDir . '/classes/meta-boxes/class-meta-box-manage.php',
    'RP4WP_Meta_Box_Options' => $baseDir . '/classes/meta-boxes/class-meta-box-options.php',
    'RP4WP_Post_Link_Manager' => $baseDir . '/classes/class-post-link-manager.php',
    'RP4WP_Post_Type_Manager' => $baseDir . '/classes/class-post-type-manager.php',
    ...
    'RP4WP_Settings_Configurator' => $baseDir . '/classes/settings/class-settings-configurator.php',
    'RP4WP_Settings_General' => $baseDir . '/classes/settings/class-settings-general.php',
    'RP4WP_Settings_License' => $baseDir . '/classes/settings/class-settings-license.php',
    'RP4WP_Settings_Misc' => $baseDir . '/classes/settings/class-settings-misc.php',
    'RP4WP_Settings_Page' => $baseDir . '/classes/settings/class-settings-page.php',
    'RP4WP_Settings_Weights' => $baseDir . '/classes/settings/class-settings-weights.php',
    'RP4WP_Settings_Words' => $baseDir . '/classes/settings/class-settings-words.php',
    'RP4WP_Thumbnail_Helper' => $baseDir . '/classes/class-thumbnail-helper.php',
    'RP4WP_Updater_Key_API' => $baseDir . '/classes/class-updater-key-api.php',
    'RP4WP_Upgrade_Manager' => $baseDir . '/classes/class-upgrade-manager.php',
);
